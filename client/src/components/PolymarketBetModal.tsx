...
export function PolymarketBetModal({ open, onClose, outcome, userBalance, mode = "buy", position }: PolymarketBetModalProps) {
  ...
  const handlePlaceBet = async () => {
    ...
    try {
      // Safe deployment is now handled during session initialization (useTradingSession.ts)
      // per Polymarket documentation: Safe must be deployed BEFORE deriving credentials
